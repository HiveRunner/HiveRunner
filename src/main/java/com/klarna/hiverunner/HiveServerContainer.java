  ...
  public List<Object[]> executeStatement(String hiveql) {
    try {
      ...
      if (handle.hasResultSet()) {
        ...
        /*
         * fetchResults will by default return 100 rows per fetch (hive 14). For big result sets we need to continuously
         * fetch the result set until all rows are fetched.
         */
        RowSet rowSet;
...
//    for (Statement statement : StatementsSplitter.splitStatements(hiveql)) {
