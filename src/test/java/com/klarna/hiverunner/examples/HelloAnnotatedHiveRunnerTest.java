...
public class HelloAnnotatedHiveRunnerTest {
    ...
    public void setupSourceDatabase() {
        hiveShell.execute(Paths.get("src/test/resources/HelloHiveRunnerTest/create_table.sql"));
        hiveShell.execute(Paths.get("src/test/resources/HelloHiveRunnerTest/create_ctas.sql"));
    }
